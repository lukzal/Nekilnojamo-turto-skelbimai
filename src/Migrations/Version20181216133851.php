...
final class Version20181216133851 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nekilnojamas_turtas DROP buto_numeris_id, DROP sklypo_plotas_id, DROP plotas, DROP kambariu_skaicius, DROP pastato_tipas, DROP metai, DROP sildymas, DROP apsauga, DROP gatves_numeris, DROP miestas, DROP aukstai');
