...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\BlokavimaiRepository' => function () {
    ...
    return ($this->privates['App\Repository\SkelbimasRepository'] ?? $this->load('getSkelbimasRepositoryService.php'));
}, 'App\\Repository\\SutartisRepository' => function () {
    return ($this->privates['App\Repository\SutartisRepository'] ?? $this->load('getSutartisRepositoryService.php'));
}))));
