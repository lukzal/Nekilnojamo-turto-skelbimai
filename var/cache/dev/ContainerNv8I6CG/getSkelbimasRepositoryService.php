...
// Returns the private 'App\Repository\SkelbimasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SkelbimasRepository.php';

return $this->privates['App\Repository\SkelbimasRepository'] = new \App\Repository\SkelbimasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
