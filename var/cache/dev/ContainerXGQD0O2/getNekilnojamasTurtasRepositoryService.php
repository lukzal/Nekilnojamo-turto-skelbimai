...
// Returns the private 'App\Repository\NekilnojamasTurtasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\NekilnojamasTurtasRepository.php';

return $this->privates['App\Repository\NekilnojamasTurtasRepository'] = new \App\Repository\NekilnojamasTurtasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
