...
// Returns the private 'App\Repository\NaudotojaiRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\NaudotojaiRepository.php';

return $this->privates['App\Repository\NaudotojaiRepository'] = new \App\Repository\NaudotojaiRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
