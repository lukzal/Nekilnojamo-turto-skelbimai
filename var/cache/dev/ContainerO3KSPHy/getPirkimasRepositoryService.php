...
// Returns the private 'App\Repository\PirkimasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PirkimasRepository.php';

return $this->privates['App\Repository\PirkimasRepository'] = new \App\Repository\PirkimasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
