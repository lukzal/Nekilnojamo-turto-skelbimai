...
// Returns the private 'App\Repository\BlokavimaiRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BlokavimaiRepository.php';

return $this->privates['App\Repository\BlokavimaiRepository'] = new \App\Repository\BlokavimaiRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
