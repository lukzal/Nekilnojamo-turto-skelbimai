...
// Returns the private 'App\Repository\NuomaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\NuomaRepository.php';

return $this->privates['App\Repository\NuomaRepository'] = new \App\Repository\NuomaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
