...
// Returns the private 'App\Repository\KlientasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\KlientasRepository.php';

return $this->privates['App\Repository\KlientasRepository'] = new \App\Repository\KlientasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
