...
// Returns the private 'App\Repository\ButasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ButasRepository.php';

return $this->privates['App\Repository\ButasRepository'] = new \App\Repository\ButasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
