...
// Returns the private 'App\Repository\NamasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\NamasRepository.php';

return $this->privates['App\Repository\NamasRepository'] = new \App\Repository\NamasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
