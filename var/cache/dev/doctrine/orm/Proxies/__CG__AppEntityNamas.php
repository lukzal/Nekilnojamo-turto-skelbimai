 ...
 */
class Namas extends \App\Entity\Namas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Namas' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Namas' . "\0" . 'sklypo_plotas'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Namas $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setSklypoPlotas(int $sklypo_plotas): \App\Entity\Namas
    {
